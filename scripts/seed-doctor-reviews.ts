    ...
    reviews: [
      {
        ...
        rating: 5,
        review_text: "Анна Олександрівна – це той лікар, до якого прийшла раз і залишилась назавжди. Уважна, тактовна, все пояснює доступно. Більше не боюсь гінекологічних процедур, бо знаю – Анна Олександрівна зробить усе максимально комфортно.",
