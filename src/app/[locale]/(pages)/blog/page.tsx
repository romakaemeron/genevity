...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const descs: Record<string, string> = {
    ua: 'Корисні статті про довголіття, діагностику та естетичну медицину від лікарів GENEVITY. Поради, відповіді на питання, огляди процедур.',
    ru: 'Полезные статьи о долголетии, диагностике и эстетической медицине от врачей GENEVITY. Советы, ответы на вопросы, обзоры процедур.',
    en: 'Useful articles on longevity, diagnostics and aesthetic medicine from GENEVITY doctors. Tips, answers to questions, procedure reviews.',
  };
