            ...
            <div className="flex flex-col gap-4" key={locale}>
              ...
              <div className="mt-2 border-t border-line pt-4">
                <FormField
                  ...
                  hint="Один реквізит на рядок у форматі «Назва: значення» — так вони виводяться окремими полями (назва зліва, значення справа). Рядок без двокрапки (назва ФОП) показується як заголовок. Перекладається окремо для кожної мови."
                />
              </div>
            </div>
          )}
