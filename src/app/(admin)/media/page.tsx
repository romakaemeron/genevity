...
export default async function MediaPage() {
  ...
  // Collect all images from the database
  ...
  return (
    <div className="p-8 max-w-5xl">
      <h1 className="heading-2 text-ink mb-2">Media Library</h1>
      <p className="body-m text-muted mb-8">{images.length} images in use</p>
