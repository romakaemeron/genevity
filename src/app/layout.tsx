    ...
    <html lang="uk" className={`${tenorSans.variable} ${mulish.variable}`}>
      ...
      <body className="antialiased">
        ...
        <Script id="binotel-widget" strategy="afterInteractive">
          {`(function(d,w,s){var widgetHash='Af6We2GQH21N1uJMFTL1',bch=d.createElement(s);bch.type='text/javascript';bch.async=true;bch.src='//widgets.binotel.com/chat/widgets/'+widgetHash+'.js';var sn=d.getElementsByTagName(s)[0];sn.parentNode.insertBefore(bch,sn);})(document,window,'script');`}
        </Script>
      </body>
    </html>
  );
