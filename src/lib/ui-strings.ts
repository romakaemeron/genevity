...
const strings = {
  ...
  duration: { ua: "Тривалість", ru: "Длительность", en: "Duration" },
  effect: { ua: "Ефект", ru: "Эффект", en: "Effect" },
  sessions: { ua: "Сеанси", ru: "Сеансы", en: "Sessions" },
  price: { ua: "Вартість", ru: "Стоимость", en: "Price" },
