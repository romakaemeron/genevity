      ...
      <AnimatePresence>
        {view === "closed" && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-[10000] w-14 h-14 rounded-full shadow-lg flex items-center justify-center hover:scale-105 active:scale-95 transition-transform"
