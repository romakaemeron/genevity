...
export default function StaticPageTemplate({
  ...
  return (
    <>
      ...
      {heroVariant === "dark" && heroImage ? (
        <section className="relative overflow-hidden bg-ink">
          ...
          <div className="relative z-[5] min-h-[60vh] lg:min-h-[65vh] flex items-end">
            <div className="max-w-[var(--container-max)] mx-auto w-full px-4 sm:px-6 lg:px-[var(--container-padding)] pb-12 lg:pb-16 pt-28">
      ...
      {/* ===== FAQ ===== */}
      {data.faq?.length > 0 && (
        <div className="max-w-[var(--container-max)] mx-auto px-4 sm:px-6 lg:px-[var(--container-padding)] pb-16">
